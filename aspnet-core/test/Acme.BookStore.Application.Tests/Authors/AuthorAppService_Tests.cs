...
namespace Acme.BookStore.Authors
{
    public class AuthorAppService_Tests:BookStoreApplicationTestBase
    {
        ...
        {
            var result = await authorAppService.GetListAsync(new GetAuthorListDto { Filter = "George" });
        ...
        {
            var authorDto = await authorAppService.CreateAsync(
                new CreateAuthorDto
                {
                    Name = "Edward Bellamy",
        ...
        public async Task Should_Not_Allow_To_Create_Duplicate_Author()
        {
            ...
            {
                await authorAppService.CreateAsync(
                    new CreateAuthorDto
                    {
                        Name = "Douglas Adams",
